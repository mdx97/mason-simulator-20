...
SOURCE_FILES = src/engine/AudioClip.cpp src/engine/AudioSystem.cpp src/engine/Engine.cpp src/engine/EventSystem.cpp src/GameScene.cpp src/GameUtility.cpp src/engine/Logger.cpp src/MainMenuScene.cpp src/engine/Mouse.cpp src/engine/RenderSystem.cpp src/engine/Scene.cpp src/engine/SceneSystem.cpp src/engine/SpriteComponent.cpp src/engine/Utility.cpp src/engine/UIComponent.cpp
